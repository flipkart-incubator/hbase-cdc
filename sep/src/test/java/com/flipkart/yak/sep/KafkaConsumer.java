...
@SuppressWarnings("WeakerAccess") public class KafkaConsumer {

  public static List<byte[]> readMessages(String topicName, final int expectedMessages)
      throws TimeoutException {

    Properties consumerProperties = new Properties();
    consumerProperties.put("zookeeper.connect", "127.0.0.1:9002");
    ...
    final KafkaStream kafkaStreams =
        javaConsumerConnector.createMessageStreams(Collections.singletonMap(topicName, 1))
            .get(topicName).get(0);
